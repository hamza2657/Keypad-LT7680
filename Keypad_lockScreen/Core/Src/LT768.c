...
* Version         : V1.0
* Date            : 2017-8-25
* Description     :Operating the register functions of the LT768
				            Please refer to the LT768.h file for which register to operate.
*********************************************************/
...
void PWM0_ON(void)
{
  	...
  	//Select_PWM1();  //enable dead zone function needs set 
   	...
   	//Auto_Reload_PWM0(); //һ��PWM����趨,������Ϊdefault 20120504
   	//One_Shot_PWM0();  //Buzzer�γ]�w

	Set_Timer0_Count_Buffer(256);  //�趨����
...
void Enable_SPI_Flash_DMA(unsigned char val)
{
	...
	Select_SFI_DMA_Mode();      // ѡ��DMAģʽ
	Select_SFI_24bit_Address(); // ѡ��24λ��ַ
