...
#define BGcolor				0x0168
#define BGcolor1				0x012E46
#define MSColor				0xA965
#define MSIndicator			0x0C74
#define RecColor			0x6062
#define ButtonBGCOlorPlus	0x578D
#define ButtonBGCOlorMinus	0xF28A
#define LampOn				0x578D
#define LampOFF				0xF28A
#define MGaugeClr			0x27E0
#define Needle				0xDC8B



//				Colors For GUI Start				//

//		Screen1			//
#define BackBlue			 	0x022D
#define LineCol			 		0x1D5F
#define Oxygen_Green		0x666B
#define Medical_Air			0xCE4B
#define CO2							0x632C
#define NIO							0x1C19
#define NI							0x0065
#define WAGD						0xC014
#define MEDVAC					0xBDD7
#define InstAir					0xC1A6
#define Menu_Bar				0x1331
#define Menu_Bar_Line		0x1BB5
#define Keyboard_Color	Table_Color
//		Screen2			//

#define BoxColor				0x0A8F
#define Table_Color			0x4B93
#define ButtonCol				0x2479
...
void LT768_DrawCircleSquare_Width(unsigned short X1,unsigned short Y1,unsigned short X2,unsigned short Y2,unsigned short X_R,unsigned short Y_R,unsigned long ForegroundColor,unsigned long CircleSquareColor ,unsigned short Width);
